...
def activity(a): #función elegir una actividad aleatorea de una lista de manera "aleatorea" y no repetible
    ...
    ACT = ["Stable Diffusion", "Tarea de Matematicas", "Tarea Proyecto de Vida", "Anime", "Descansar", "Practicar Robotica", "Proyecto WetteRv1", "Proyecto GarrDenV2", "AFRSv2"] #lista de actividades
